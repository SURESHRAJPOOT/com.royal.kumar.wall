...
.field private final h:La/i/b/c;

.field private final i:La/i/b/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v4, v3}, La/i/b/c;->n(Landroid/view/ViewGroup;FLa/i/b/c$c;)La/i/b/c;

    move-result-object v5

    iput-object v5, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    invoke-virtual {v5, p2}, La/i/b/c;->K(I)V

    invoke-virtual {v5, v2}, La/i/b/c;->L(F)V

    invoke-virtual {v3, v5}, Landroidx/drawerlayout/widget/DrawerLayout$g;->q(La/i/b/c;)V

    invoke-static {p0, v4, p3}, La/i/b/c;->n(Landroid/view/ViewGroup;FLa/i/b/c$c;)La/i/b/c;

    move-result-object v3

    iput-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;

    const/4 v4, 0x2

    invoke-virtual {v3, v4}, La/i/b/c;->K(I)V

    invoke-virtual {v3, v2}, La/i/b/c;->L(F)V

    invoke-virtual {p3, v3}, Landroidx/drawerlayout/widget/DrawerLayout$g;->q(La/i/b/c;)V

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setFocusableInTouchMode(Z)V

    invoke-static {p0, p2}, La/g/l/s;->u0(Landroid/view/View;I)V
    ...
    invoke-static {p0, p2}, La/g/l/s;->l0(Landroid/view/View;La/g/l/a;)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroid/view/ViewGroup;->setMotionEventSplittingEnabled(Z)V

    invoke-static {p0}, La/g/l/s;->y(Landroid/view/View;)Z
...
.method static A(Landroid/view/View;)Z
    ...
    invoke-static {p0}, La/g/l/s;->z(Landroid/view/View;)I
...
.method private V(Landroid/view/View;Z)V
    ...
    :goto_1
    invoke-static {v2, v3}, La/g/l/s;->u0(Landroid/view/View;I)V
...
.method public N(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    invoke-virtual {p1}, Landroid/view/View;->getTop()I

    move-result v0

    invoke-virtual {p2, p1, v1, v0}, La/i/b/c;->O(Landroid/view/View;II)Z

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;
    ...
    invoke-virtual {p2, p1, v0, v1}, La/i/b/c;->O(Landroid/view/View;II)Z
...
.method public T(II)V
    ...
    invoke-static {p2, v0}, La/g/l/d;->b(II)I
    ...
    :goto_1
    invoke-virtual {p2}, La/i/b/c;->a()V
...
.method W(IILandroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    invoke-virtual {p1}, La/i/b/c;->z()I

    move-result p1

    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;

    invoke-virtual {v0}, La/i/b/c;->z()I
    ...
    invoke-interface {p2, v1}, Landroidx/drawerlayout/widget/DrawerLayout$d;->b(I)V
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, p2}, La/g/l/s;->l0(Landroid/view/View;La/g/l/a;)V
...
.method public computeScroll()V
    ...
    iget-object v0, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, La/i/b/c;->m(Z)Z

    move-result v0

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;

    invoke-virtual {v2, v1}, La/i/b/c;->m(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v8, v0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    invoke-virtual {v8}, La/i/b/c;->w()I
    ...
    iget-object v10, v0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;

    invoke-virtual {v10}, La/i/b/c;->w()I
...
.method i(Z)V
    ...
    iget-object v7, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;
    ...
    invoke-virtual {v7, v4, v6, v8}, La/i/b/c;->O(Landroid/view/View;II)Z
    ...
    :cond_1
    iget-object v6, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;
    ...
    invoke-virtual {v6, v4, v7, v8}, La/i/b/c;->O(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    invoke-virtual {v1, p1}, La/i/b/c;->N(Landroid/view/MotionEvent;)Z

    move-result v1

    iget-object v2, p0, Landroidx/drawerlayout/widget/DrawerLayout;->i:La/i/b/c;

    invoke-virtual {v2, p1}, La/i/b/c;->N(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p1, v4}, La/i/b/c;->d(I)Z
    ...
    iget-object v4, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    float-to-int v0, v0

    float-to-int p1, p1

    invoke-virtual {v4, v0, p1}, La/i/b/c;->t(II)Landroid/view/View;
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, La/g/l/s;->y(Landroid/view/View;)Z
    ...
    :goto_2
    invoke-static/range {p0 .. p0}, La/g/l/s;->B(Landroid/view/View;)I
    ...
    invoke-static {v15, v7}, La/g/l/d;->b(II)I

    move-result v15

    invoke-static {v12}, La/g/l/s;->y(Landroid/view/View;)Z
    ...
    invoke-static {v12}, La/g/l/s;->w(Landroid/view/View;)F
    ...
    invoke-static {v12, v14}, La/g/l/s;->s0(Landroid/view/View;F)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, La/i/b/c;->E(Landroid/view/MotionEvent;)V
    ...
    iget-object v3, p0, Landroidx/drawerlayout/widget/DrawerLayout;->h:La/i/b/c;

    float-to-int v4, v0

    float-to-int v5, p1

    invoke-virtual {v3, v4, v5}, La/i/b/c;->t(II)Landroid/view/View;
    ...
    invoke-virtual {v3}, La/i/b/c;->y()I
...
.method public setDrawerElevation(F)V
    ...
    invoke-static {v0, v1}, La/g/l/s;->s0(Landroid/view/View;F)V
